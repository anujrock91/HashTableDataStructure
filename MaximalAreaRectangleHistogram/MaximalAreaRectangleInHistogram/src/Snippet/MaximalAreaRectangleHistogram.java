...
public class MaximalAreaRectangleHistogram {
	...
	public int getMaxArea(int []nums){
		...
		while(!s.isEmpty()){
			...
			if(s.isEmpty()){
				...
				area = (nums[temp]*(index-nums[s.peek()]-1));
				max = Math.max(area, max);
			}
		}
	...
	public static void main(String args[]){
		System.out.println(new MaximalAreaRectangleHistogram().getMaxArea(new int[]{0,3,1,1,1}));
	}
}
