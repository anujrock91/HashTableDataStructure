...
public class Twitter {
    ...
    public List<Integer> getNewsFeed(int userId) {
    	...
    	for(Integer user: userFollows){
    		...
    		if(tempObj == null){ System.out.println("No user Id as : " + user); continue; }
    ...
    public static void main(String args[]){
    	...
    	obj.postTweet(1, 13);
    	obj.postTweet(4, 42);
    	obj.postTweet(1, 14);obj.postTweet(1, 15);obj.postTweet(1, 16);
    	obj.postTweet(2, 22);obj.postTweet(2, 23);obj.postTweet(2, 24);
    	//obj.unfollow(1, 3);
    	List<Integer> tweets = obj.getNewsFeed(1);
